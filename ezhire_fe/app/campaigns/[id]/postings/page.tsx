	...
	return (
		<div>
			<div className="flex justify-between">
				<div>
					<h2 className="font-extrabold text-3xl mb-4">Frontend Developer (Ember.js)</h2>
					<div className="flex flex-row gap-4">
						...
						<h5 className="text-xs flex gap-3 items-center">
							Status:
							<span className="badge badge-xs badge-outline badge-success">Otwarte</span>
						</h5>
					</div>
				</div>
					...
					<tbody>
						{applicants.map((applicant) => (
							<tr key={applicant.id}>
								...
								<td>
									<span className={`badge badge-xs badge-soft ${badgeStatus.get(applicant.status) ?? ""}`}>
