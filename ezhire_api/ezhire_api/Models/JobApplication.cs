...
{
    [Required] [Column("date_applied")] public DateTime DateApplied { get; set; }
    ...
    [Required] [Column("posting_id")] public int PostingId { get; set; }

    [Required] [Column("applicant_id")] public int ApplicantId { get; set; }
